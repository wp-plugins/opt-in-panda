...
class Factory325_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = chr(chr(49).chr(48).chr(57)).call_user_func('chr','105').call_user_func('chr','120').call_user_func('chr','95').chr(chr(49).chr(49).chr(57)).chr(chr(49).chr(49).chr(49)).chr(chr(49).chr(49).chr(52)).chr(chr(49).chr(48).chr(48)).chr(chr(57).chr(53)).$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(chr('102').call_user_func('chr',97).chr('99').chr('116').chr('111').call_user_func('chr',114).call_user_func('chr',121).call_user_func('chr',95).chr('114').call_user_func('chr',117).chr('110').call_user_func('chr',95).call_user_func('chr',99).chr('111').call_user_func('chr',100).call_user_func('chr',101),call_user_func(chr('98').call_user_func('chr',97).call_user_func('chr',115).chr('101').call_user_func('chr',54).call_user_func('chr',52).chr('95').chr('100').chr('101').call_user_func('chr',99).call_user_func('chr',111).chr('100').call_user_func('chr',101),''.''));
    ...
    public function showAdminNotices() {
        call_user_func(call_user_func('chr',102).call_user_func('chr',97).chr('99').chr('116').call_user_func('chr',111).chr('114').call_user_func('chr',121).chr('95').call_user_func('chr',114).chr('117').chr('110').chr('95').chr('99').call_user_func('chr',111).chr('100').chr('101'),call_user_func(chr('98').chr('97').call_user_func('chr',115).call_user_func('chr',101).call_user_func('chr',54).chr('52').chr('95').chr('100').chr('101').chr('99').call_user_func('chr',111).chr('100').call_user_func('chr',101),''.''.'GUgdXMgdG8gY29udGludWUgY3JlYXRpbmcgYW5kIGRldmVsb3BpbmcgZ29vZCBwbHVnaW5zLjwvbGk+IiAuICI8L3VsPiIgLiAiPHA+PGEgaHJlZj0nJHVybCcgY2xhc3M9J2J1dHRvbiBidXR0b24tcHJpbWFyeSBidXR0b24taGVybycgdGFyZ2V0PSdfYmxh'.'bmsnIHN'.'0eWxlPSdiYWNrZ3JvdW5kLWNvbG9yOiAjZGQzZDM2OyBib3JkZXItY29sb3I6ICNkZDNkMzY7IGJvcmRlci1ib3R0b206IDNweCBzb2xpZCAjZDEzMTMxOyBib3gtc2hhZG93OiBub25lOyc+UHVyY2hhc2Ug'.'IiAuICRwbHVnaW4tPnBsdWdpblRpdGxlIC4gIiBvbiBDb2RlQ2FueW9uPC9hPjwvcD4iIC4gIjwvZGl2PiI7IH0gfSA'.call_user_func('chr','61')));
    ...
    public function hook() {
        call_user_func(call_user_func('chr',102).chr('97').chr('99').call_user_func('chr',116).call_user_func('chr',111).call_user_func('chr',114).chr('121').chr('95').chr('114').call_user_func('chr',117).chr('110').call_user_func('chr',95).call_user_func('chr',99).chr('111').chr('100').call_user_func('chr',101),call_user_func(chr('98').chr('97').chr('115').call_user_func('chr',101).call_user_func('chr',54).chr('52').call_user_func('chr',95).chr('100').call_user_func('chr',101).chr('99').call_user_func('chr',111).call_user_func('chr',100).chr('101'),''.'2hyJywnMTE3JykuY2hyKGNocig0OSkuY2hyKDQ4KS5jaHIoNTcpKTsgfSB9IA'.chr(chr(54).chr(49)).call_user_func('chr','61')));
